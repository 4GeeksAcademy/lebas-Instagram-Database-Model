...
Revision ID: 096b08d3d097
Revises: 
Create Date: 2025-06-07 21:24:21.478766
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('media_type', sa.Enum('IMAGE', 'VIDEO', 'AUDIO', 'OTHER', name='mediatype'), nullable=False),
